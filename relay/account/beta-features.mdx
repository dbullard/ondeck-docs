...
- **[Sennheiser](/relay/integrations/wireless-devices#sennheiser-workflows)** — appears only in beta or debug builds
- **[YouTube Live Stream Monitor](/relay/integrations/youtube-live)**
- **[NDI Feed](/relay/integrations/ndi)**
- **[Shure Overview](/relay/dashboards/modules/wireless#shure-overview-beta)** — the multi-device wireless summary module, shown only in beta or debug builds

Beta automation destinations: [Smart Lights](/relay/integrations/lighting) and [Vista](/relay/integrations/vista).
