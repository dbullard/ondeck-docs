...
<Steps>
  ...
  <Step title="Run the Setup Wizard (optional)">
    On first launch, the Setup Wizard can do most of the setup for you. It finds your devices, connects your services, suggests starter tiles, and builds your first dashboard with a live layout preview. Free and Pro users see their own step sequences.

    <Tip>
      You can reopen the wizard at any time from the `File` menu on Mac or the ellipsis menu on iOS (Coming Soon).
    </Tip>
  </Step>
