...
<Steps>
  ...
  <Step title="Run the Setup Wizard (optional)">
    The [Setup Wizard](/guides/setup-wizard) can do most of the setup for you. It walks you through connecting your services, choosing starter tiles with a live layout preview, and creating your first dashboard. Every step is optional.
