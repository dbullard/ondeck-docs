...
- **[Sennheiser](/integrations/wireless-devices#sennheiser-workflows)** — appears only in beta or debug builds
- **[YouTube Live Stream Monitor](/integrations/youtube-live)**
- **[NDI Feed](/integrations/ndi)**
- **[Shure Overview](/dashboards/modules/wireless#shure-overview-beta)** — the multi-device wireless summary module, shown only in beta or debug builds

Beta automation destinations: [Smart Lights](/integrations/lighting) and [Vista](/integrations/vista).
