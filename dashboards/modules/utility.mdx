...
- **Shared Values:** Text inputs can use values you define in the Variables window, so you can change a value once and have it update everywhere it is used. See [Shared values and variables](/dashboards/variables).
