...
Values you define in the Variables window are available to automations as well as text inputs, so one change stays consistent across your graphs and dashboard. See [Shared values and variables](/dashboards/variables).
