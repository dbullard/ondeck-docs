...
You can rerun the [Setup Wizard](/guides/setup-wizard) from the `File` menu whenever you add new devices or services.
...
Define a value once and reuse it across text inputs and automations. See [Shared values and variables](/dashboards/variables).
